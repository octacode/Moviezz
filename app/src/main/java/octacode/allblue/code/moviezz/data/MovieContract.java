...
public class MovieContract {
    ...
    static final String PATH_MOVIE_TABLE = "movie";

    private static final String PATH_FAV_TABLE = "favourites";

    static final String CONTENT_AUTHORITY = "octacode.allblue.code.moviezz";
    ...
    public static final class FavouritesTable implements BaseColumns{
        ...
        static final String COLUMN_MAIN_PAGE_INT = "page";
        static final String COLUMN_MAIN_POSTER_PATH_TEXT = "poster_path";
        static final String COLUMN_MAIN_ADULT_TEXT = "adult";
        static final String COLUMN_MAIN_OVERVIEW_TEXT= "overview";
        public static final String COLUMN_MAIN_MOVIE_ID_DOUBLE = "movie_id";
        static final String COLUMN_MAIN_TITLE_TEXT = "title";
        static final String COLUMN_MAIN_ORG_LANGUAGE_TEXT = "original_lainguage";
        static final String COLUMN_MAIN_BACKDROP_PATH_TEXT = "backdrop_path";
        static final String COLUMN_MAIN_GENRE_IDS_TEXT = "genre_ids";
        static final String COLUMN_MAIN_RATINGS_DOUBLE = "ratings";
        static final String COLUMN_MAIN_POPULARITY_DOUBLE = "popularity";
        static final String COLUMN_MAIN_VOTE_COUNT_DOUBLE = "vote_count";
        static final String COLUMN_MAIN_VOTE_AVERAGE_DOUBLE = "vote_average";
    }
